...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="adminTopic.html" target="right"><span class="icon-caret-right"></span>话题管理</a></li>
    <li><a href="adminComment.html" target="right"><span class="icon-caret-right"></span>评论管理</a></li>
  </ul>   
