...
<body>
          ...
          <button type="submit" class="button border-red"><span class="icon-trash-o"></span> 批量删除</button>
			...
			<table class="table table-hover text-center">
				...
				<c:forEach var="orderItem" items="${orderDetail.orderItems}"
					varStatus="status">
					<td>${orderItem.audio.name}</td>
					<td>${orderItem.audio.category.name}</td>
					<td>${orderItem.audio.otherItem}</td>
	...
	<div class="button-group"> <a class="button border-green" href="order_finishOrder.action?orderId=${orderDetail.id}" ><span class="icon-circle-o"></span>完成订单</a> </div>
	</c:if>
