  ...
  <div class="body-content">
    <form method="post" class="form-x" action="audio_doAddAudio.action">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="audio.name" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
   ...
   <!--   <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="audio.otherItem" style=" height:90px;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="audio.stock" data-validate="required:请输入库存" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
