...
<body>
	...
	<div id="box">
		...
		<div class="containerchild">
			<h1>请输入用户ID</h1>
			<form class="form" method="POST" id="login_form" action="workerReturn_deleteborrowRecord.action">
				<input name="audioID" id="audioId" type="hidden"> <input
					name="userID" type="text" placeholder="用户ID"
			...
			<table class="table table-hover text-center">
				...
				<tr>
					...
					<td><div class="button-group">
							<a class="button border-red" href="workerAudio_toChangeAudioInfo.action?audio.id=${audio.id}"><span
								class="icon-circle-o"></span>修改</a>
							<a class="button border-red" href="javascript:del('${audio.id}')"><span
								class="icon-circle-o"></span>删除</a>
	...
	<script type="text/javascript">
		...
		function del(id) {
			if (confirm("您确定要删除吗?")) {
			//alert(id);
				window.location.href="workerAudio_deleteAudio.action?audio.id="+id;
			}
		}
