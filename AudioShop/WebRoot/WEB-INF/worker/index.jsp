...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="static/images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />收银员管理中心</h1>
  </div>
  <div class="head-l">
  <c:choose>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="buy_toBuy.action" target="right"><span class="icon-caret-right"></span>卖资料</a></li>
    <li><a href="borrow_toBorrow.action" target="right"><span class="icon-caret-right"></span>借资料</a></li>
    <li><a href="workerReturn_toReturn.action"  target="right"><span class="icon-caret-right"></span>还资料</a></li>
    <li><a href="workerAudio_toAllAudio.action" target="right"><span class="icon-caret-right"></span>查看所有资料</a></li>  
    <li><a href="worker_toAddVip.action" target="right"><span class="icon-caret-right"></span>添加会员</a></li>   
  </ul>   
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="workerAudio_toAllAudio.action" name="right" width="100%" height="100%"></iframe>
</div>
